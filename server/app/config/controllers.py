...
@configs.route('/add/config/',              methods = ['PUT', 'POST'])
@configs.route('/add/session/config/',      methods = ['PUT', 'POST'])
@login_required
def config_add():
    """
...
@configs.route('/add/session/',             methods = ['PUT', 'POST'])
@login_required
def session_add():
    """
...
@configs.route('/add/favorite/',            methods = ['PUT', 'POST'])
@login_required
def favorite_add():
    """
...
@configs.route('/delete/config/',           methods = ['DELETE', 'UPDATE'])
@configs.route('/delete/session/config/',   methods = ['DELETE', 'UPDATE'])
@login_required
def config_delete():
    """
    Delete a config
...
@configs.route('/delete/session/',          methods = ['DELETE', 'UPDATE'])
@login_required
def session_delete():
    """
    Delete a session
...
@configs.route('/delete/favorite/',         methods = ['DELETE', 'UPDATE'])
@login_required
def favorite_delete():
    """
    Delete a session
...
@configs.route('/modify/config/',         methods = ['PUT', 'UPDATE', 'POST'])
@configs.route('/modify/session/config/', methods = ['PUT', 'UPDATE', 'POST'])
@login_required
def config_modify():
    """
    Modify a config.
...
@configs.route('/favorite/set/config/',         methods = ['PUT', 'UPDATE', 'POST'])
@configs.route('/favorite/set/session/',        methods = ['PUT', 'UPDATE', 'POST'])
@login_required
...
@configs.route('/favorite/get/config/',         methods = ['GET', 'POST'])
@configs.route('/favorite/get/session/',        methods = ['GET', 'POST'])
@login_required
